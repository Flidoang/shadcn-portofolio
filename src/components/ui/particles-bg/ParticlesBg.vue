...
function animate() {
  ...
  circles.value.forEach((circle, i) => {
    ...
    const statMag = props.staticity / circle.magnetism;
    circle.translateX += (mouse.x / statMag - circle.translateX) / props.ease;
    circle.translateY += (mouse.y / statMag - circle.translateY) / props.ease;
